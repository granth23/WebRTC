...
server.listen(PORT, () => {
  console.log(`User interface available at http://localhost:${PORT}`);
});
...
<html lang="en">
  <head>
    ...
    <title>User interface – build required</title>
    <style>
  ...
  <body>
    <main>
      <h1>User application build not found</h1>
      <p>The compiled assets for the user interface are missing. Build them with:</p>
      <ol>
        <li><code>cd user</code></li>
        <li><code>npm install</code></li>
        <li><code>npm run build</code></li>
        <li><code>npm start</code></li>
      </ol>
      <p>During development you can run <code>npm run dev</code> inside <code>user/</code> to launch the Vite dev server.</p>
    </main>
  </body>
</html>`;
}
