...
function App() {
  ...
  function beginSession(event) {
    ...
    setupSocket((socket) => {
      ...
      const details = {
        ...
        fatherName: panDetails.fatherName ? formatPanName(panDetails.fatherName) : '',
  ...
  const verificationCodeDisplay = hasVerificationCode
    ? verificationCode
    : sessionState === 'idle'
    ? 'Start the call to receive your code'
    : 'Generating…';
              ...
              <section className="controls">
                <div className="card session-card">
                  ...
                  <div className="form-actions">
                    ...
                    {sessionState === 'idle' ? (
                      <button type="button" className="primary-button" onClick={beginSession}>
                        Begin verification call
                      </button>
                    ) : (
                      <button type="button" className="danger-button" onClick={handleLeaveSession}>
                        End session
                      </button>
                    )}
                  </div>
                ...
                <div className="session-status" role="status" aria-live="polite">
                  <div>
                    <span className="status-heading">Current status</span>
                    <p>{status}</p>
                  </div>
                  <div className="session-status-meta">
                    <span>
                      Verification code{' '}
                      {hasVerificationCode ? (
                        <code>{verificationCodeDisplay}</code>
                      ) : (
                        <span className="code-placeholder">{verificationCodeDisplay}</span>
                      )}
                    </span>
                    {roomId && (
                      <span>
                  ...
                  {error && <p className="session-status-error">{error}</p>}
                </div>
              </section>
